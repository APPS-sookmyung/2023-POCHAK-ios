...
extension AlarmViewController: UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        print(self.responseData?.result.alarmElementList.count)
        return self.responseData?.result.alarmElementList.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
//        if(self.responseData?.result.alarmElementList[indexPath.item].alarmType == AlarmType.ownerComment){
...
//            }
//            if let userSentAlarmHandle = self.responseData?.result.alarmElementList[indexPath.item].userSentAlarmHandle {
...
//            return cell
//        }
//        else if(self.responseData?.result.alarmElementList[indexPath.item].alarmType == AlarmType.ownerComment){
//            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: OtherCollectionViewCell.identifier, for: indexPath) as? OtherCollectionViewCell else{
//                fatalError("셀 타입 캐스팅 실패")
//            }
...
//            return cell
//        }
//        else if(self.responseData?.result.alarmElementList[indexPath.item].alarmType == AlarmType.like){
//            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: OtherCollectionViewCell.identifier, for: indexPath) as? OtherCollectionViewCell else{
//                fatalError("셀 타입 캐스팅 실패")
//            }
//            if let userSentAlarmHandle = self.responseData?.result.alarmList[indexPath.item].userSentAlarmHandle {
...
//            return cell
//        }
//        else if(self.responseData?.result.alarmElementList[indexPath.item].alarmType == AlarmType.tagApproval){
